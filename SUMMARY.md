...
* [机器学习：使用Python](README.md)
   * [简介Scikit-learn 机器学习](Introduction/intro.md)
...
* [通用范例 General Examples](general_examples/general_examplesmd.md)
...
* [机器学习资料集 Datasets](Datasets/datasets.md)
   * [Ex 1: The digits 手写数字辨识](Datasets/ex1_the_digits_dataset.md)
   * [Ex 3: The iris 鸢尾花资料集](Datasets/ex3_the_iris_dataset.md)
* [应用范例 Application](application/application.md)
   * [波士顿房地产云端评估(一)](application/Property_Value/linear_regression.md)
   * [波士顿房地产云端评估(二)](application/Property_Value/SVR.md)
* [类神经网路 Neural_Networks](Neural_Networks/Neural_network_models_supervised.md)
...
* [决策树 Decision_trees](Decision_trees/Decision_trees.md)
